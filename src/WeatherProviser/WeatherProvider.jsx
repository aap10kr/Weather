...
function WeatherProvider({children}){
  ...
  const getWeatherInfo = async () => {
    try{
      const currentWeatherInfoAPI = "https://api.openweathermap.org/data/2.5/weather?appid=1a2bcc37713c5a5f7309a6af416ac7f5&q=seoul&units=metric";
      ...
      const hourlyWeatherInfoAPI = `https://api.openweathermap.org/data/2.5/onecall?lat=${lat}&lon=${lon}&exclude=current,minutely,daily&appid=1a2bcc37713c5a5f7309a6af416ac7f5`
